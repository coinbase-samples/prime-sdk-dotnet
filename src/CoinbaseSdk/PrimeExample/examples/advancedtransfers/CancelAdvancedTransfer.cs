...
var advancedTransferIdOption = new Option<string>(
    ...
    description: "The Advanced Transfer ID to cancel");

var rootCommand = new RootCommand("Cancel an advanced transfer")
{
    portfolioIdOption,
...
rootCommand.SetHandler((portfolioId, advancedTransferId) =>
{
    ...
    try
    {
        ...
        var response = service.CancelAdvancedTransfer(request);
    ...
    {
        PrettyPrinter.PrintError("Error cancelling advanced transfer", ex);
        Environment.ExitCode = 1;
    }

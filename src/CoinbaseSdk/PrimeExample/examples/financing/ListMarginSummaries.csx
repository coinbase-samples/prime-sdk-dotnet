...
var request = new ListMarginSummariesRequest.ListMarginSummariesRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = financingService.ListMarginSummaries(request);
    PrettyPrinter.PrintResponse("ListMarginSummariesResponse", response);
}
catch (Exception ex)
{

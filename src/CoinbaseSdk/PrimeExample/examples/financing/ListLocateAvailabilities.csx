...
var financingService = client.FinancingService;

var request = new ListLocateAvailabilitiesRequest.ListLocateAvailabilitiesRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = financingService.ListLocateAvailabilities(request);
    PrettyPrinter.PrintResponse("ListLocateAvailabilitiesResponse", response);
}
catch (Exception ex)
{

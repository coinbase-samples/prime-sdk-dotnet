...
var usersService = client.UsersService;

var request = new ListEntityUsersRequest.ListEntityUsersRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = usersService.ListEntityUsers(request);
    PrettyPrinter.PrintResponse("ListEntityUsersResponse", response);
}
catch (Exception ex)
{

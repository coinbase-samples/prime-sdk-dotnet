...
var request = new GetEntityPaymentMethodsRequest.GetEntityPaymentMethodsRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = entitiesService.GetEntityPaymentMethods(request);
    PrettyPrinter.PrintResponse("GetEntityPaymentMethodsResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error retrieving entity payment methods", ex);
}
...
var request = new ListEntityPositionsRequest.ListEntityPositionsRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = entitiesService.ListEntityPositions(request);
    PrettyPrinter.PrintResponse("ListEntityPositionsResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error retrieving entity positions", ex);
}
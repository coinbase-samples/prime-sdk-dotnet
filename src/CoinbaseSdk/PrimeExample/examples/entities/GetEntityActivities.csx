...
var request = new GetEntityActivitiesRequest.GetEntityActivitiesRequestBuilder()
...
try
{
    var response = entitiesService.GetEntityActivities(request);
    PrettyPrinter.PrintResponse("GetEntityActivitiesResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error retrieving entity activities", ex);
}
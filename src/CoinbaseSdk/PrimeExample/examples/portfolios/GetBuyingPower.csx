...
var request = new GetBuyingPowerRequest.GetBuyingPowerRequestBuilder()
    .WithPortfolioId(portfolioId)
    .Build();

try
{
    var response = portfoliosService.GetBuyingPower(request);
    PrettyPrinter.PrintResponse("GetBuyingPowerResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error retrieving buying power", ex);
}
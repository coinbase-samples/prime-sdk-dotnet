...
var request = new GetPortfolioActivitiesRequest.GetPortfolioActivitiesRequestBuilder()
...
try
{
    var response = portfoliosService.GetPortfolioActivities(request);
    PrettyPrinter.PrintResponse("GetPortfolioActivitiesResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error retrieving portfolio activities", ex);
}
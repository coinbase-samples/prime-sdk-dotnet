...
var request = new GetPortfolioAllocationsRequest.GetPortfolioAllocationsRequestBuilder()
...
{
    PrettyPrinter.PrintError("Error retrieving portfolio allocations", ex);
}
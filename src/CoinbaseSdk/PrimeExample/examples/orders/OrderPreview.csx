...
try
{
    var response = ordersService.OrderPreview(request);
    PrettyPrinter.PrintResponse("OrderPreviewResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error previewing order", ex);

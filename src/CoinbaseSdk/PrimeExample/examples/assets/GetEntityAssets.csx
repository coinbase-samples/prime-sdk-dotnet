...
var request = new GetEntityAssetsRequest.GetEntityAssetsRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = assetsService.GetEntityAssets(request);
    PrettyPrinter.PrintResponse("GetEntityAssetsResponse", response);
}
catch (Exception ex)
{

...
var assetsService = client.AssetsService;

var request = new ListEntityAssetsRequest.ListEntityAssetsRequestBuilder()
    .WithEntityId(entityId)
    .Build();

try
{
    var response = assetsService.ListEntityAssets(request);
    PrettyPrinter.PrintResponse("ListEntityAssetsResponse", response);
}
catch (Exception ex)
{
    PrettyPrinter.PrintError("Error retrieving entity assets", ex);
}
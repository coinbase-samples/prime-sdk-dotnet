...
else
{
    PrettyPrinter.PrintUsage(
        "dotnet script GetWallet.csx <wallet-id>", 
        "dotnet script GetWallet.csx sample-wallet-id-12345");
    return;
}

var request = new GetWalletRequest.GetWalletRequestBuilder()
...
{
    PrettyPrinter.PrintError("Error retrieving wallet", ex);
